...
## Example
### Blueprint
[This Home Assistant blueprint](https://github.com/Nicxe/f1_sensor/blob/main/examples/blueprint.yaml) by community member [EvertJob](https://github.com/EvertJob) watches your Formula 1 track status sensor and updates a chosen light’s color and brightness to reflect the current track condition. 
...
If you would like to update the current version on you're HA instance please follow the steps provided [here](https://www.home-assistant.io/docs/automation/using_blueprints/#re-importing-a-blueprint) because it's not nessacary to remove the blueprint and import it again!
