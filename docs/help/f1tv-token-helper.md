...
description: Complete the pairing started in Home Assistant using the Token Helper browser extension.
---
...
Public callback URLs must use HTTPS. Plain HTTP is accepted only for local Home Assistant hosts such as `localhost`, `.local` names, and private network addresses.
